...
export const Footer = () => {
  return (
    <footer className="text-center bg-white text-black">
      <div className="container px-6 pt-6 mx-auto">
        <div className="flex justify-center">
          <a
            href="#"
            type="button"
            className="rounded-full border-2 border-black text-black leading-normal uppercase hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
              aria-hidden="true"
              focusable="false"
      ...
      <div className="text-center p-2">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          © 2022 Copyright: Powered by Christian Vergara Rootlab Student
        </a>
      </div>
    </footer>
  );
